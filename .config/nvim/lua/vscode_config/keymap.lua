-- copied from https://medium.com/@nikmas_dev/vscode-neovim-setup-keyboard-centric-powerful-reliable-clean-and-aesthetic-development-582d34297985
...
keymap('n', '<S-tab>', "<cmd>lua require('vscode').action('workbench.action.previousEditor')<CR>")
