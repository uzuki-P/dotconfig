...
Hostnames matching `dev-<8 hex>` are generated by the sibling `../dev-router`
registry and loaded through Caddy's loopback admin API. Use
`dev-route publish <port>` rather than editing this file for temporary
development servers.
